...
const RilevamentoDetail = ({ rilevamento, onClose, showOperaio = false }: RilevamentoDetailProps) => {
        ...
        {showOperaio && (
          <section className="detail-section detail-section--meta">
            ...
            <div className="detail-grid">
              ...
              {rilevamento.submit_timestamp && (
                <div className="detail-item">
                  <span className="detail-item__label">Data registrazione</span>
                  <span className="detail-item__value">{formatTimestamp(rilevamento.submit_timestamp)}</span>
                </div>
              )}
